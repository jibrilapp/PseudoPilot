...
Translator subset: assignment, INPUT/OUTPUT, expressions, CHAR, indexes, **IF**, **WHILE**, **REPEAT**, **FOR**.
Unsupported constructs (CASE, DECLARE, routines, …) show diagnostics without crashing the UI.
